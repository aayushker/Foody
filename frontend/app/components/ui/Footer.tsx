...
export default function Footer() {
  return (
    <Card isBlurred radius="lg" className="bg-gray-1000 " shadow="md">
      <footer className="dark:bg-gray-900 text-white">
        <div className="mx-auto max-w-full-xl pb-6 sm:px-6 lg:px-8 lg:pt-12">
          <div className="flex justify-between ">
            <div>
              ...
              <p className="text-md mt-6 text-center text-gray-500">
        ...
        <div className="py-4 px-2  dark:border-gray-800">
